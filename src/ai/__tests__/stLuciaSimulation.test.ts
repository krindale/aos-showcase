...
import { isTrackPartOfCompletedLink, findTrackCubeDeliveries } from '@/utils/hexGrid';
...
describe('St. Lucia 2 AI 전체 게임 — VP / 파산 게이트', () => {
  ...
  function measure(seeds = 20) {
    ...
    return { avgVP, minVP: Math.min(...allVPs), maxVP: Math.max(...allVPs), avgShares, avgIncome, bankruptcies, finishedTurns, seeds, avgDeliveries, avgCubesLeft, avgDeliverableLeft, avgBuilds, avgUrban, avgSkips, avgTurns };
  }
