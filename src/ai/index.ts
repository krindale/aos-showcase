 ...
 * 테스트(VITEST)는 기존 1000 유지 — 실시간 러너(buildLimitByLog 등)의 벽시계 예산이
 * 1000 기준으로 잡혀 있어 1350이면 턴 진행 미달로 간헐 실패한다 (게임 로직 무관).
 */
export const AI_TURN_DELAY =
  typeof process !== 'undefined' && process.env?.VITEST ? 1000 : 1350;
